...
class Produccion_model extends CI_Model {
    ...
    public function gestion_monografia($codigo){
        ...
        $crud->fields('PROD_CODIGO','PROD_TITULO','PROD_RESUMEN','PROD_FECHA_PUBLICACION','PROD_GRUPO_INVESTIGACION', 'PROD_PERMISO','PROD_ESTADO','MONOGRAFIA_TIPO','MONOGRAFIA_ARCHIVO_ADJUNTO','MONOGRAFIA_AUTOR1','MONOGRAFIA_AUTOR2','MONOGRAFIA_CODIRECTOR');
        
        /*campos en add*/
        $crud->add_fields('PROD_CODIGO','PROD_TITULO','PROD_RESUMEN','PROD_FECHA_PUBLICACION','PROD_GRUPO_INVESTIGACION', 'PROD_PERMISO','PROD_ESTADO','MONOGRAFIA_TIPO','PROD_ARCHIVO_ADJUNTO','MONOGRAFIA_AUTOR1','MONOGRAFIA_AUTOR2','MONOGRAFIA_CODIRECTOR');
        
        /*campos en edit*/
        $crud->edit_fields('PROD_CODIGO','PROD_TITULO','PROD_RESUMEN','PROD_FECHA_PUBLICACION','PROD_GRUPO_INVESTIGACION', 'PROD_PERMISO','PROD_ESTADO','MONOGRAFIA_TIPO','PROD_ARCHIVO_ADJUNTO','MONOGRAFIA_AUTOR1','MONOGRAFIA_AUTOR2','MONOGRAFIA_CODIRECTOR');
